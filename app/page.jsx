...
export default function HomePage() {
  ...
  const [stats, setStats] = useState({ notes: 0, bookmarks: 0, favorites: 0 })
      ...
      if (response.ok) {
        ...
        if (notesRes.ok && bookmarksRes.ok) {
          ...
          setStats({
            ...
            favorites: [...notes, ...bookmarks].filter((item) => item.isFavorite).length,
          })
        }
      } else {
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <h1 className="text-2xl font-bold text-gray-900">Notes & Bookmarks</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Create and manage your personal notes with tags</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Save and organize your favorite websites</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex space-x-2">
